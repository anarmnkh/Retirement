...
const News = () => {
  return (
    <div className="relative h-screen">
      ...
      <Image src={bg} layout="fill" objectFit="cover" alt="/"  objectPosition="center" />
            ...
            {serviceItems.map((item, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg">
                ...
                <div className="bg-slate-100 p-4 flex justify-end">
                  <a href={item.link} className="text-indigo-100 hover:text-indigo-800 flex items-center" aria-label={`Learn more about ${item.title}`}> {/* Added aria-label */}
