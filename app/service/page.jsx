...
import Service1 from "../../public/pic1.jpeg";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-5xl px-4 py-4">
        <li
          onClick={() => router.back()}
          className="flex items-center text-black hover:text-blue-700"
        >
            ...
            <div className="p-6 flex flex-col justify-between flex-grow">
              ...
              <div className="text-center">
                <Link href={`/service/${service.type}`}>
                  <button
                    className="w-full py-3 px-4 border-2 text-sm font-medium rounded-full"
